...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (textElement) {
        const texts = [
            "Creador de contenido de magia siniestra..",
            "Tengo varios proyectos, como Patreon donde subo contenido de magia siniestra. Pero con diferentes temas no permitidos por otras plataformas..",
            "Creación y venta de articulos magicos..",
            "Cuento con mi Canal de Youtube llamado Ecos Del Abismo..",
            "Magia Siniestra, entre otros conocimientos de magia y culturas..",
